    ...
    <div class="bg-white rounded-xl shadow-lg flex w-[62.5rem] p-8">
        ...
        <div class="w-1/2 flex flex-col justify-center">
            ...
            <div class="mt-6 flex flex-col gap-4">
                <a href="{{ route('register') }}" class="bg-blue-500 text-white text-center py-2 rounded-lg font-semibold hover:bg-blue-700 transition mt-14">
                    Sou professor
                </a>
                <a href="{{ route('register') }}" class="bg-blue-500 text-white text-center py-2 rounded-lg font-semibold hover:bg-blue-700 transition mt-7">
                    Sou aluno
                </a>
            </div>
