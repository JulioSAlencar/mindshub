...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/profileUser', [ProfileController::class, 'editPerfil'])->name('profile.show');
...
// ✅ Agora você pode acessar todas as rotas diretamente sem login.
// 🔒 Para reativar a proteção:
// 1️⃣ Descomente o bloco `Route::middleware('auth')->group(function () {` e `});`
// 2️⃣ Garanta que o middleware de autenticação esteja configurado corretamente
// 3️⃣ O sistema voltará a exigir login para acesso às rotas protegidas
